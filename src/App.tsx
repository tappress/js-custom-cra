...
const App = () => {
  ...
  useEffect(() => {
    (document.getElementById('bg-video') as HTMLVideoElement).playbackRate = 0.75;
  }, [])
          ...
          <div className={styles.app}>
            ...
            <div className={styles.videoBackground}>
              <video 
                ...
                id="bg-video"
              >
                <source src="/js-slots-cra/yarmarok.mp4" type="video/mp4" />
              </video>
              <div className={styles.overlay} />
            </div>

            {/* Main Content */}
            <div className={`${styles.mainContent} ${isLoading ? styles['app--loading'] : ''}`}>
              <Header />
